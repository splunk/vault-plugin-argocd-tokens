...
// Force a newer version of this indirect dependency to avoid a no license issue
require github.com/acomagu/bufpipe v1.0.4-0.20210605013841-cd7a5f79d3c4 // indirect
